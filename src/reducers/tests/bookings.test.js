...
it('changes status of request to pending true', () => {
  expect(bookings(INITIAL_GET_BOOKING_STATE, pendingBookingRequest)).toEqual(pendingBookingResult);
});

it('changes status of request to pending false and payload contains bookings', () => {
  expect(bookings(INITIAL_GET_BOOKING_STATE, successfulBookingRequest)).toEqual(successfulBookingRequestResult);
});

it('changes status of request to pending false and payload is empty', () => {
  expect(bookings(INITIAL_GET_BOOKING_STATE, errorBookingRequest)).toEqual(errorBookingRequestResult);
});
...
it('changes status of request to pending true', () => {
  expect(bookings(INITIAL_GET_BOOKING_STATE, pendingPostBookingRequest)).toEqual(pendingPostBookingResult);
});

it('changes status of request to pending false and payload contains bookings', () => {
  expect(bookings(INITIAL_GET_BOOKING_STATE, successfulPostBookingRequest)).toEqual(successfulPostBookingRequestResult);
});

it('changes status of request to pending false and payload is empty', () => {
  expect(bookings(INITIAL_GET_BOOKING_STATE, errorPostBookingRequest)).toEqual(errorPostBookingRequestResult);
});
...
it('changes status of request to pending true', () => {
  expect(bookings(INITIAL_DEL_STATE, pendingDeleteBookingRequest)).toEqual(pendingDeleteBookingResult);
});

it('changes status of request to pending false and payload has removed the booking', () => {
  expect(bookings(INITIAL_DEL_STATE, successfulDeleteBookingRequest)).toEqual(successfulDeleteBookingRequestResult);
});

it('changes status of request to pending false and payload has not removed the booking', () => {
  expect(bookings(INITIAL_DEL_STATE, errorDeleteBookingRequest)).toEqual(errorDeleteBookingRequestResult);
});